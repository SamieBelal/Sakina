...
export const nameTeachings: NameTeaching[] = [
  // ─────────────────────────────────────────────
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'اللَّهُمَّ إِنَّكَ رَحْمَانٌ رَحِيمٌ وَرَحْمَتُكَ وَسِعَتْ كُلَّ شَيْءٍ فَارْحَمْنِي',
      transliteration: 'Allahumma innaka Rahmanun Rahimun wa rahmatuka wasi\'at kulla shay\'in farhamni',
      translation: 'O Allah, You are Ar-Rahman, Ar-Rahim, and Your mercy encompasses all things, so have mercy on me.',
      source: 'Derived from Quranic attributes (7:156) and Prophetic tradition',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'يَا وَاحِدُ يَا أَحَدُ اجْمَعْ شَمْلِي وَوَحِّدْ قَصْدِي لَكَ',
      transliteration: 'Ya Wahidu Ya Ahad, ijma\' shamli wa wahhid qasdi lak',
      translation: 'O One, O Uniquely One, gather my scattered self and unify my purpose for You.',
      source: 'Derived from the teaching of Al-Wahid and Al-Ahad in the Dua I Need series',
    },
  },

  // ─────────────────────────────────────────────
  // AL-HADI / AN-NUR — The Guide / The Light
  // ─────────────────────────────────────────────
  {
    name: 'Al-Hadi / An-Nur',
    ...
    dua: {
      arabic: 'اللَّهُمَّ اجْعَلْ فِي قَلْبِي نُورًا وَفِي لِسَانِي نُورًا وَاجْعَلْنِي نُورًا',
      transliteration: "Allahumma ij'al fi qalbi nuran wa fi lisani nuran waj'alni nuran",
      translation: 'O Allah, place light in my heart, light on my tongue, and make me a light.',
      source: 'Bukhari — said by the Prophet ﷺ on his way to prayer',
    },
  },

  // ─────────────────────────────────────────────
  // AR-RABB — The Lord and Nurturer
  // ─────────────────────────────────────────────
  {
    name: 'Ar-Rabb',
    arabic: 'الرَّبُّ',
    ...
    dua: {
      ...
      transliteration: "Allahumma inni a'udhu bi-ridaka min sakhatika wa bi-mu'afatika min 'uqubatika wa a'udhu bika minka",
      translation: 'O Allah, I seek refuge in Your pleasure from Your anger, and in Your pardon from Your punishment, and I seek refuge in You from You.',
      source: 'Muslim — said by the Prophet ﷺ, the language of one who knows refuge is only found in the One he fears to disappoint',
    },
  },

  // ─────────────────────────────────────────────
  // AL-GHAFIR / AL-GHAFFAR / AL-GHAFOOR / AT-TAWWAB
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: "Rabbighfir li wa tub 'alayya innaka anta't-Tawwabu'r-Rahim",
      translation: 'My Lord, forgive me and accept my repentance. Indeed, You are At-Tawwab, Ar-Rahim.',
      source: 'Bukhari — the Prophet ﷺ said this 100 times a day',
    },
  },

  // ─────────────────────────────────────────────
  // AS-SAMI' / AL-QARIB / AL-MUJIB — The Hearer / The Near / The Answerer
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: 'Quran 11:61 — words of the Prophet Salih (عليه السلام)',
    },
  },

  // ─────────────────────────────────────────────
  // AL-BASIR / ASH-SHAHID / AR-RAQIB / AS-SITTIR
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'يَا بَصِيرُ أَنْتَ تَرَى مَا لَا يَرَى أَحَدٌ فَاشْهَدْ لِي بِمَا لَا يَعْلَمُهُ سِوَاكَ',
      transliteration: "Ya Basir, anta tara ma la yara ahad, fashhadli bima la ya'lamuhu siwak",
      translation: 'O All-Seeing, You see what no one else sees. Bear witness for me in what only You know.',
      source: 'Derived from the teaching of Al-Basir and Ash-Shahid in the Dua I Need series',
    },
  },

  // ─────────────────────────────────────────────
  // AL-GHANI / AL-HAMID / AL-FATTAH
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: 'Quran 7:89 — dua of the Prophet Shu\'ayb (عليه السلام)',
    },
  },

  // ─────────────────────────────────────────────
  // AL-ALIM / AL-HAKIM / AL-LATIF — The All-Knowing / All-Wise / Subtle
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: "Allahumma ya Lateefu, lutf bi fi umuri kulliha",
      translation: 'O Allah, O Gentle One, be gentle with me in all my affairs.',
      source: "Traditional dua derived from the Name Al-Latif, cited in the Dua I Need series",
    },
  },

  // ─────────────────────────────────────────────
  // AL-QAHHAR / AL-JABBAR — The Subduer / The Compeller-Healer
  // ─────────────────────────────────────────────
  {
    ...
    coreTeaching:
      'When you stand face to face with injustice, you don\'t need gentle names — you need the names that shake thrones. Al-Qahhar is the one who has the upper hand over all creation. He governs your heartbeat without permission, and He controls the tyrant\'s next breath without asking. Allah\'s delay is not neglect. Quran 14:42: "And never think that Allah is unaware of what the wrongdoers do. He only delays them [i.e., their account] for a Day when eyes will stare [in horror]." And Quran 8:30, on the schemers: "But they plan, and Allah plans. And Allah is the best of planners." Al-Jabbar means the Compeller AND the Healer — the word "jabara" means to set a broken bone back into place. Al-Qahhar breaks, Al-Jabbar repairs. Al-Qahhar presses the arrogant down, Al-Jabbar lifts the broken up.',
    propheticStory:
    ...
    dua: {
      ...
      source: 'Derived from the teaching of Al-Qahhar and Al-Jabbar in the Dua I Need series',
    },
  },

  // ─────────────────────────────────────────────
  // AL-ADL / AL-HAKAM / AL-HASIB — The Just / The Judge / The Reckoner
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'اللَّهُمَّ احْكُمْ بَيْنَنَا وَبَيْنَ قَوْمِنَا بِالْحَقِّ وَأَنتَ خَيْرُ الْحَاكِمِينَ',
      transliteration: "Allahumma ij'al baynana wa bayna qawmina bil-haqq wa anta khayrul-hakimin",
      translation: 'O Allah, judge between us and our people in truth — You are the best of judges.',
      source: 'Derived from Quran 7:87 and the teaching of Al-Hakam in the Dua I Need series',
    },
  },

  // ─────────────────────────────────────────────
  // ASH-SHAFI / AT-TAYYIB — The Healer / The Pure
  // ─────────────────────────────────────────────
  {
    name: 'Ash-Shafi',
    arabic: 'الشَّافِي',
    ...
    dua: {
      ...
      transliteration: "Allahumma Rabban-nasi, adhhib il-ba's, ishfi anta'sh-Shafi, la shifa'a illa shifa'uk, shifa'an la yughadiru saqama",
      translation: 'O Allah, Lord of people, remove the illness, heal — You are the Healer, there is no healing except Your healing, a healing that leaves no illness behind.',
      source: 'Bukhari and Muslim — dua for healing said by the Prophet ﷺ',
    },
  },

  // ─────────────────────────────────────────────
  // AS-SABUR / AL-HALIM — The Patient / The Forbearing
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'اللَّهُمَّ إِنِّي أَسْأَلُكَ الصَّبْرَ وَأَعُوذُ بِكَ مِنَ الْجَزَعِ',
      transliteration: "Allahumma inni as'alukas-sabra wa a'udhu bika minal-jaza'",
      translation: 'O Allah, I ask You for patience and I seek refuge in You from anxiety and distress.',
      source: 'Derived from Prophetic supplications for patience',
    },
  },

  // ─────────────────────────────────────────────
  // AL-ALI / AL-MUTA'ALI — The Exalted / The Supremely Exalted
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'يَا عَلِيُّ يَا مُتَعَالِي ارْفَعْ قَلْبِي فَوْقَ الضَّغِينَةِ وَالصِّغَارِ',
      transliteration: "Ya 'Aliyyu ya Muta'ali, irfa' qalbi fawqa'd-daghina wa's-sighar",
      translation: 'O The Exalted, O The Supremely Exalted, raise my heart above resentment and smallness.',
      source: 'Derived from the closing dua of Ep. 24 of the Dua I Need series',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'اللَّهُمَّ أَنتَ الْأَوَّلُ فَلَيْسَ قَبْلَكَ شَيْءٌ وَأَنتَ الْآخِرُ فَلَيْسَ بَعْدَكَ شَيْءٌ',
      transliteration: "Allahumma anta'l-Awwalu fa laysa qablaka shay', wa anta'l-Akhiru fa laysa ba'daka shay'",
      translation: 'O Allah, You are the First — nothing before You. You are the Last — nothing after You.',
      source: "Muslim — the Prophet ﷺ's prayer that frames existence from beginning to end",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'يَا وَدُودُ يَا رَحِيمُ اجْعَلْ فِي قَلْبِي مَحَبَّتَكَ وَحَبِّبْنِي إِلَيْكَ',
      transliteration: "Ya Wadud, Ya Rahim, ij'al fi qalbi mahabbataka wa habbibni ilayk",
      translation: 'O Loving, O Merciful, place Your love in my heart and make me beloved to You.',
      source: "Derived from the teaching of Al-Wadud in the Dua I Need series",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      translation: 'O Allah, You are Al-\'Afuw, You love to pardon, so pardon me.',
      source: 'Al-Tirmidhi — taught by the Prophet ﷺ to Aisha specifically for Laylat al-Qadr',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      translation: 'Allah is sufficient for us, and He is the best of trustees.',
      source: 'Quran 3:173 — spoken by the companions when warned of their enemies',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: "Rabbana innaka jami'un-nasi li-yawmin la rayba fih, innallaha la yukhlifu'l-mi'ad",
  ...
  // ─────────────────────────────────────────────
  // AL-KARIM / AL-WAHHAB — The Generous / The Bestower
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: "Rabbana la tuzigh qulubana ba'da idh hadaytana wahab lana min ladunka rahmah, innaka anta'l-Wahhab",
      translation: 'Our Lord, do not let our hearts deviate after You have guided us. Grant us from Yourself mercy. Indeed, You are Al-Wahhab.',
      source: 'Quran 3:8',
    },
  },

  // ─────────────────────────────────────────────
  // AL-HAYY / AL-QAYYUM — The Ever-Living / Self-Sustaining
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      translation: 'O Ever-Living, O Self-Sustaining, in Your mercy I seek help. Rectify all my affairs and do not leave me to myself even for the blink of an eye.',
      source: 'Al-Hakim — taught by the Prophet ﷺ to his daughter Fatima for morning and evening',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'اللَّهُمَّ يَا صَمَدُ اجْعَلْنِي غَنِيًّا بِكَ عَنْ سِوَاكَ',
      transliteration: "Allahumma ya Samad, ij'alni ghaniyyan bika 'an siwak",
      translation: 'O Allah, O Eternal Refuge, make me needless of all others through You.',
      source: 'Derived from the teaching of As-Samad in the Dua I Need series',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: "Allahumma anta's-sahibu fi's-safar wa'l-khalifatu fi'l-ahl",
      translation: 'O Allah, You are my companion in travel and the guardian over my family.',
      source: 'Muslim — Dua al-Safar, extended by scholars to mean the journey of life',
    },
  },

  // ─────────────────────────────────────────────
  // AL-'ALI / AL-'AZIM / AL-MAJID
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Said in ruku' — instructed by the Prophet ﷺ when this verse was revealed",
    },
  },

  // ─────────────────────────────────────────────
  // AS-SALAM / AL-QUDDUS — Peace / The Holy
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: "Allahumma anta's-Salamu wa minka's-salamu tabarakta ya Dhal Jalali wa'l-Ikram",
      translation: 'O Allah, You are As-Salam and from You comes all peace. Blessed are You, O Possessor of Majesty and Honor.',
      source: 'Muslim — said by the Prophet ﷺ after every obligatory prayer',
    },
  },

  // ─────────────────────────────────────────────
  // AL-QAWI / AL-MATIN — The Powerful / The Firm
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Bukhari and Muslim — described by the Prophet ﷺ as a treasure from beneath Allah's throne",
    },
  },

  // ─────────────────────────────────────────────
  // AL-DHAHIR & AL-BATIN — The Manifest & The Hidden
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'أَنْتَ الظَّاهِرُ فَلَيْسَ فَوْقَكَ شَيْءٌ وَأَنْتَ الْبَاطِنُ فَلَيْسَ دُونَكَ شَيْءٌ',
      transliteration: "Anta al-Dhahiru fa-laysa fawqaka shay', wa anta al-Batinu fa-laysa dunaka shay'",
      translation: 'You are Al-Dhahir — there is nothing above You. You are Al-Batin — there is nothing closer to me than You.',
      source: "Sahih Muslim 2713 — part of the bedtime dua the Prophet ﷺ taught, pairing Al-Dhahir and Al-Batin",
    },
  },

  // ─────────────────────────────────────────────
  // AL-GHANI — The Self-Sufficient, The Enricher
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      translation: 'O Allah, enrich me with Your bounty so that I need no one but You.',
      source: 'Prophetic supplication calling on Al-Ghani — used when feeling empty, dependent on creation, or chasing completion in the wrong places',
    },
  },

  // ─────────────────────────────────────────────
  // AL-MU'IZZ & AL-MUDHIL — The Bestower of Honor & The Humiliator
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Traditional supplication based on the teaching that izza lies exclusively in obedience to Allah",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: 'Supplication calling on Al-Jabbar — used when broken in body, heart, or spirit and seeking divine restoration',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      translation: 'Allah is sufficient for me and He is the best Disposer of affairs. What an excellent Protector and what an excellent Helper.',
      source: "Quran 3:173 and 8:40 — combined into one supplication of complete reliance on Allah",
    },
  },

  // ─────────────────────────────────────────────
  // AR-RABB — The Lord, The Nurturer
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Quran 20:25-26 — the dua of Moses when given an overwhelming task, calling on Ar-Rabb specifically",
    },
  },

  // ─────────────────────────────────────────────
  // AL-QARIB / AL-MUJIB — The Near / The Responder
  ...
  // ─────────────────────────────────────────────
  {
    ...
    propheticStory:
      "The Prophet Yunus (عليه السلام) left his people before Allah gave him permission. He boarded a ship, a storm arose, and lots were drawn — his name came up every time. He was thrown into the sea and swallowed by the whale. Three layers of darkness: the night, the ocean, the belly of the whale. Scholars say the angels heard his call coming from that deep dark place and recognized the voice — this is the one who used to call on Allah in the times of ease. They brought his dua before Allah, and he was answered. The hadith says: remember Allah in ease and He will remember you in hardship. No matter what sin placed you in your dark place — He is still just as close. Shaitan will tell you your sins have pushed you too far. They haven't. Yunus was in the darkest place a human can be, and Al-Qarib was still right there. He just had to call.",
    dua: {
      arabic: 'لَا إِلَهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ',
      transliteration: 'La ilaha illa anta subhanaka inni kuntu minaz-zalimin',
      translation: 'There is no god but You, glory be to You; indeed I have been of the wrongdoers.',
      source: "Quran 21:87 — the dua of Yunus (AS) from the belly of the whale. The Prophet ﷺ said no Muslim calls with this dua except that Allah responds.",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Sahih Muslim 591 — recited by the Prophet ﷺ after every obligatory prayer",
    },
  },

  // ─────────────────────────────────────────────
  // AR-RAZZAQ — The Provider, The Sustainer of All
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: "Allahumma-kfini bihalалика 'an haramika wa aghнini bifadlika 'amman siwak",
      translation: 'O Allah, suffice me with what You have made lawful, sparing me from what You have made unlawful, and enrich me with Your bounty so that I need no one but You.',
      source: "Jami' at-Tirmidhi 3563 — a supplication for provision that removes dependence on people",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'اللَّهُمَّ اجْعَلْ فِي قَلْبِي نُورًا وَفِي لِسَانِي نُورًا وَاجْعَلْنِي نُورًا',
      transliteration: "Allahumma-j'al fi qalbi nuran wa fi lisani nuran waj'alni nuran",
      translation: 'O Allah, place light in my heart, light on my tongue, and make me light.',
      source: 'Sahih Muslim 763 — the Prophet\'s dua on the way to Fajr prayer',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Jami' at-Tirmidhi 3513 — the dua the Prophet ﷺ taught Aisha to say on Laylat al-Qadr",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    coreTeaching:
      "Al-Karim has six dimensions: He gives wanting nothing in return; He gives for no reason — not as a reward, just because; He gives to everyone regardless of who they are or what they've done; He gets happy when you receive His gifts; He gives and then praises you for having the quality; and He overlooks punishment. Al-Karim is the one who gives to those who don't deserve it. This is why Allah introduced Himself to the Prophet ﷺ in the very first revelation with this very quality — 'Iqra' wa rabbuka al-Akram,' Quran 96:3: \"Recite, and your Lord is the most Generous\" (al-Akram, the superlative of Karim). The Prophet ﷺ answered the angel three times, \"I do not know how to read\" (Sahih al-Bukhari 3) — and the revelation came anyway. That is Karam: unworthiness is not the obstacle — it is the very reason the gift comes. The scholars say: call on Al-Karim specifically for duas you think are too big to ask. The logic of Karim is that it doesn't follow logic. The more undeserving you feel, the more fitting it is to call on this name. And when you truly internalize it, you stop begging others for what only He can give — because you already know who has undertaken to provide for you.",
    propheticStory:
    ...
    dua: {
      ...
      source: "Traditional supplication calling on the name Al-Karim — taught specifically for duas that feel 'too big to ask'",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    coreTeaching:
      "Al-Fattah is the Opener — the One who holds the keys to every closed door, every sealed heart, every locked situation. The Quran says: 'Whatever Allah opens for people from His mercy, no one can hold it back.' And what Allah holds back, no one can open. This name is for every person staring at a door that won't move — a heart that won't soften, a career that won't break through, a marriage that won't come, an addiction that won't release its grip. Al-Fattah doesn't open on your timeline. He opens when it's best. And He often combines Al-Fattah with Al-Alim — the Most Knowledgeable — because the opening comes when He knows it's right, not when you think it should. The door that didn't open wasn't a failure. It was Al-Fattah redirecting you. Allah only closes doors because He is opening other ones. Quran 7:96 ties the opening of baraka to belief and taqwa: 'And if only the people of the cities had believed and feared Allah, We would have opened [i.e., bestowed] upon them blessings from the heaven and the earth.' And the Prophet ﷺ said: 'Indeed, Allah is Hayy, Generous, when a man raises his hands to Him, He feels too shy to return them to him empty and rejected' (Jami' at-Tirmidhi 3556). When you raise your hands to Al-Fattah and you know who you're asking, the One you're asking feels shy to let those hands drop without something in them. Two practices from this name: never lose hope that openings are always coming — especially for things that look completely sealed. And run toward the wall. Don't wait to see the door open first. Run at it, knowing Al-Fattah will open it. That's how you get to Hogwarts.",
    propheticStory:
    ...
    dua: {
      ...
      source: 'Supplication calling on Al-Fattah — used when facing closed doors, sealed hearts, or situations that feel impossible to move through',
    },
  },

  // ─────────────────────────────────────────────
  // AL-SHAKUR — The Appreciative, The Most Grateful
  ...
  // ─────────────────────────────────────────────
  {
    ...
    coreTeaching:
      "Al-Shakur comes from the Arabic root shakaba — you give an animal a little food and it gives you back enormous amounts of milk. That is Al-Shakur: the One who takes a little and repays massively, far beyond what was deserved. This name is for everyone who was told growing up that they hadn't done enough. The A-minus that felt like a failure. The sacrifice no one noticed. The grind nobody saw. So many of us have internalized that nothing we do is ever enough — and we carry that wound into our relationship with Allah, thinking: 'My deeds are too small, my prayers too distracted, my good too little.' But you have forgotten who you're giving to. Al-Shakur doesn't measure the size of your deed. He measures the sincerity. A man walking along a path found a thorny twig lying on the way and put it aside; the Prophet ﷺ said Allah appreciated it and forgave him (Sahih Muslim 1914). A man dying of thirst climbed down a well to drink, came out and found a dog eating the earth from thirst, went back down and filled his shoe with water for it; Allah thanked him for it and forgave him (Sahih al-Bukhari 2466). The Prophet ﷺ said: our two-rakat prayer — half-distracted, made while thinking about work — is still seen, still valued, still lifted up by Al-Shakur. Your struggle no one else has witnessed? Al-Shakur witnessed it. Your sacrifice that got no thank-you? Al-Shakur is the only one whose appreciation truly fills that void. Ibn Ata'illah: 'Sins that make you feel low and in need of Allah are better than worship that makes you arrogant.' And Al-Shakur is paired in the Quran with Al-Halim — the One who not only forgives but acts as if He didn't even see the wrong. You are seen. You are valued. Whatever little you have done — it was enough.",
    propheticStory:
      "The Prophet ﷺ said in a hadith qudsi: 'My servant draws near to Me with the obligatory deeds. Then he continues with the voluntary deeds until I love him. And when I love him, I become the hearing with which he hears, the sight with which he sees, the hand with which he strikes, and the feet with which he walks.' Al-Shakur doesn't just notice what you do — He transforms you through it. Sheikh Mikaeel reflects: 'I myself had internalized this need for approval so deeply from my childhood. As I started to say this name more, I started to realize that Allah was saying: just do what you can. That's enough for Me. The moment I started to say that, the anxiety lifted. Because in the back of my head I'd been trying to prove something to my dad. To my older brother. But the moment you say Ya Shakur, you shift it. You put Allah right back in that place of true value.' And when the angels find a gathering of His remembrance, Allah says: 'So I do call You to witness that I have forgiven them.' They say: 'Indeed among them is so-and-so, a sinner, he did not intend them, he only came to them for some need.' So He says: 'They are the people, that none who sits with them shall be miserable.' (Jami' at-Tirmidhi 3600, Sahih)",
    dua: {
      arabic: 'يَا شَكُورُ اشْكُرْ لِي سَعْيِي وَلَا تَخْذُلْنِي',
      transliteration: 'Ya Shakuru ushkur li sa\'yi wa la takhdhulni',
      translation: 'O Most Appreciative, appreciate my striving and do not abandon me.',
      source: 'Supplication calling on Al-Shakur — used when feeling unseen, unappreciated, or like one\'s efforts are too small to matter',
    },
  },

  // ─────────────────────────────────────────────
  // AL-WAKIL — The Disposer of Affairs, The Trustee
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Quran 3:173 — the words the Prophet ﷺ and the Sahaba said when told 'the people have gathered against you, so fear them.' Also the dua of Ibrahim as he was thrown into the fire.",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Jami' at-Tirmidhi 3490 — part of a longer dua the Prophet ﷺ taught Mu'adh ibn Jabal",
    },
  },

  // ─────────────────────────────────────────────
  // AT-TAWWAB — The Ever-Returning, The Acceptor of Repentance
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      transliteration: 'Allahumma ighfir li wa tub alayyah innaka anta at-tawwabur-rahim',
      translation: 'O Allah, forgive me and accept my repentance. Indeed You are At-Tawwab, the Most Merciful.',
      source: 'From the sunnah — the Prophet ﷺ would say this and similar phrases over 100 times in a single gathering',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      translation: 'O Allah, guide us and make us a means of guidance for others.',
      source: 'Prophetic supplication — used when asking Al-Hadi for direction and to become a guide for others',
    },
  },

  // ─────────────────────────────────────────────
  // AL-QABID & AL-BASIT — The Constrictor & The Expander
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'يَا قَابِضُ يَا بَاسِطُ ابْسُطْ عَلَيْنَا مِنْ رَحْمَتِكَ',
      transliteration: "Ya Qabiду ya Basitu ibsut 'alayna min rahmatik",
      translation: 'O Constrictor, O Expander — spread over us from Your mercy.',
      source: 'Supplication calling on Al-Qabid and Al-Basit together — used in moments of constriction to remember that both states are from Allah and both carry His mercy',
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Adapted from the prophetic morning dua — asking Al-Muqaddim and Al-Mu'akhkhir for contentment in one's season",
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      arabic: 'يَا لَطِيفُ الْطُفْ بِي فِيمَا جَرَتْ بِهِ الْمَقَادِيرُ',
      transliteration: 'Ya Lateefu ultuf bi fima jarat bihi al-maqadir',
      translation: 'O Subtle One, be gentle with me in all that destiny has decreed.',
      source: 'Traditional dua of the awliya — recited morning and evening, calling on Al-Latif in hardship and uncertainty',
    },
  },

  // ─────────────────────────────────────────────
  // AL-WAHHAB — The Bestower of Gifts
  ...
  // ─────────────────────────────────────────────
  {
    ...
    dua: {
      ...
      source: "Quran 3:38 — Dua of Zakariah (AS), used when asking Al-Wahhab for what seems impossible",
    },
  },
];
 ...
 */
export function getRelevantTeachings(userText: string): NameTeaching[] {
  const lower = userText.toLowerCase();

  // Keyword-to-name-index mapping for fast matching
  const keywordMap: Array<[string[], number]> = [
    [['sin', 'guilt', 'shame', 'forgive', 'repent', 'tawbah', 'forgiven', 'wrong'], 4],   // Al-Ghaffar
    [['heard', 'prayer', 'dua', 'answer', 'respond', 'listen'], 5],                         // As-Sami
    [['seen', 'invisible', 'unnoticed', 'witness', 'nobody sees'], 6],                       // Al-Basir
    [['stuck', 'trapped', 'door', 'way out', 'blocked', 'same cycle'], 7],                  // Al-Fattah
    [['why', 'wisdom', 'pain', 'makes no sense', 'understand', 'purpose'], 8],              // Al-Latif
    [['oppressed', 'injustice', 'tyrant', 'unfair', 'bully', 'oppressor'], 9],              // Al-Qahhar
    [['justice', 'account', 'reckoning', 'judge', 'wrong', 'unpunished'], 10],              // Al-Adl
    [['heal', 'sick', 'illness', 'pain', 'disease', 'medicine'], 11],                       // Ash-Shafi
    [['patient', 'patience', 'react', 'anger', 'frustrated', 'snap'], 12],                  // As-Sabur
    [['time', 'death', 'end', 'passing', 'wasted', 'future', 'dying'], 13],                 // Al-Awwal
    [['love', 'lonely', 'unloved', 'alone', 'heartbreak', 'connection'], 14],              // Al-Wadud
    [['guilty', 'erased', 'pardon', 'laylat al-qadr', 'wiped clean'], 15],                 // Al-Afuw
    [['anxious', 'anxiety', 'control', 'worry', 'fear', 'helpless'], 16],                   // Al-Wakil
    [['scattered', 'lost dreams', 'gather', 'wasted effort'], 17],                          // Al-Jami
    [['money', 'provision', 'rizi', 'finances', 'poor', 'gift', 'generous'], 18],           // Al-Karim
    [['alone', 'middle of night', 'despair', 'everything falling apart'], 19],              // Al-Hayy
    [['empty', 'nothing satisfies', 'restless', 'hollow', 'craving'], 20],                  // As-Samad
    [['abandoned', 'no one', 'stranger', 'lonely', 'nobody', 'bereaved'], 21],             // Al-Wali
    [['humiliated', 'small', 'insignificant', 'crushed', 'ego'], 22],                       // Al-Ali/Azim
    [['peace', 'trauma', 'restless', 'panic', 'anxiety'], 23],                              // As-Salam
    [['exhausted', 'weak', 'powerless', 'give up', 'burned out'], 24],                     // Al-Qawi
    [['mercy', 'unworthy', 'hopeless', 'depressed', 'burden'], 0],                         // Ar-Rahman
    [['divided', 'distracted', 'scatter', 'validation', 'approval'], 1],                   // Al-Wahid
    [['guidance', 'confused', 'direction', 'doubt', 'dark', 'lost faith'], 2],             // Al-Hadi
    [['purpose', 'meaning', 'lord', 'belonging', 'nobody cares', 'enslaved'], 3],           // Ar-Rabb
    [['allah absent from my life', 'can\'t see allah anywhere', 'spiritually disconnected', 'only focused on appearances', 'heart feels dirty', 'hidden resentment', 'can\'t find meaning in daily life', 'mundane has no connection to god', 'is god really there', 'feel like allah doesn\'t see me', 'hollow inside externally fine'], 26], // Al-Dhahir/Al-Batin
    [['feel empty', 'void inside', 'still not satisfied', 'chasing the next thing', 'filling emptiness', 'looking for completion', 'restless despite blessings', 'always wanting more', 'shopping to feel better', 'career not fulfilling', 'missing something'], 27], // Al-Ghani
    [['chasing approval from people', 'compromising deen for status', 'give up values to get ahead', 'seeking honor from boss', 'disrespected', 'sacrificing prayers for career', 'islam holding me back', 'worried what people think', 'people-pleasing', 'feel humiliated', 'giving up identity for acceptance', 'career pressure to fit in', 'selling out', 'am i sacrificing allah'], 28], // Al-Mu'izz/Al-Mudhil
    [['broken heart', 'broken', 'fix me', 'something is wrong', 'can\'t be fixed', 'no one can help', 'doctors don\'t know', 'feel shattered', 'emotionally broken', 'financially broke', 'need to be mended', 'being forced', 'someone controlling me'], 29], // Al-Jabbar
    [['overpowered', 'helpless', 'stuck', 'can\'t break', 'addiction', 'doing it alone', 'people let me down', 'no way out', 'too weak', 'overwhelmed', 'self-sufficient', 'can\'t find a way'], 30], // An-Nasir
    [['scared about the future', 'big transition', 'between jobs', 'waiting and don\'t know what\'s next', 'no one looking out for me', 'feel abandoned in hard season', 'have to figure it all out myself', 'can\'t see how it will work out', 'feel on my own', 'everything changed and not ready', 'who is taking care of me', 'going through transition'], 31], // Ar-Rabb
    [['anxious about money', 'worried about provision', 'scared about finances', 'feel like i have to figure out finances alone', 'scared i won\'t have enough', 'jealous of others\' wealth', 'boss controls my future', 'scarcity mindset', 'can\'t trust things will work out', 'grinding but not enough', 'feel like i\'m providing for everyone', 'slave to the means'], 32], // Ar-Razzaq
    [['far from allah', 'feel distant', 'allah doesn\'t hear', 'dua unanswered', 'stopped making dua', 'sins pushed me away', 'don\'t feel worthy to ask', 'feel alone with my problems', 'nobody understands'], 33], // Al-Qarib/Al-Mujib
    [['no peace', 'restless', 'hollow', 'nothing satisfies', 'searching for peace', 'empty inside', 'addicted', 'substance', 'shop', 'shopping', 'grind', 'marriage complete me', 'jealousy', 'arrogance', 'hatred'], 34], // As-Salam
    [['feel spiritually empty', 'heart is dark', 'spiritually dead', 'can\'t find clarity', 'feel disconnected from allah', 'heart feels hard', 'walking in the dark', 'don\'t feel the light', 'lost my sense of purpose', 'confused about my path', 'don\'t feel ramadan', 'spiritually hollow'], 35], // An-Nur
    [['stuck on sin', 'can\'t forgive myself', 'stopped praying', 'shame holding', 'too sinful', 'broken relationship', 'grudge', 'let go', 'past mistakes', 'cringe', 'can\'t move on'], 36], // Al-'Afuww
    [['undeserving', 'don\'t deserve', 'not worthy', 'earn my way', 'low self-worth', 'who am i to ask', 'dua too big', 'ashamed to ask allah', 'too big to ask', 'need to prove myself first'], 37], // Al-Karim
    [['door keeps closing', 'stuck with no way forward', 'tried everything', 'heart feels locked', 'nothing opening', 'can\'t break through', 'everything seems impossible', 'gave up on a dream', 'trapped', 'people blocking me', 'closed door', 'sealed heart'], 38], // Al-Fattah
    [['never appreciated', 'nothing i do is enough', 'nobody sees my struggle', 'feel invisible', 'need validation', 'good deeds feel worthless', 'nobody values me', 'chasing approval', 'my efforts don\'t matter', 'never satisfied with me', 'nobody acknowledges my sacrifice', 'grind no one notices'], 39], // Al-Shakur
    [['feel like everything depends on me', 'can\'t let go of control', 'anxious about the future', 'grinding but nothing is working', 'scared to stop trying', 'feel responsible for everyone', 'trying to control outcomes', 'exhausted from carrying it all', 'trust issues', 'people let me down', 'afraid to rely on anyone', 'can\'t hand it over'], 40], // Al-Wakil
    [['feel like allah doesn\'t love me', 'wonder if allah cares', 'transactional relationship', 'worship out of obligation', 'feeling unloved', 'hardship means allah hates me', 'not feeling close to allah', 'seeking love from people', 'earn allah\'s love', 'going through the motions', 'can\'t feel allah\'s presence', 'spiritually dry'], 41], // Al-Wadud
    [['sin i keep doing', 'can\'t stop sinning', 'too sinful for allah', 'ashamed to pray', 'allah hates me', 'feel like a hypocrite', 'gave up repentance', 'keep falling back', 'won\'t forgive me', 'disconnected because of sin', 'too far gone'], 42], // At-Tawwab
    [['lost', 'don\'t know what to do', 'no purpose', 'empty inside', 'have everything but', 'feel directionless', 'which path', 'what\'s next', 'spiritually stagnant', 'afraid to change', 'get back on track'], 43], // Al-Hadi (Mikaeel)
    [['bad day for no reason', 'heart feels heavy', 'lost my job', 'financial hardship', 'life is contracting', 'scared of down moments', 'allah withholding', 'can\'t shake sadness', 'rough patch', 'everything going wrong', 'stuck in a low', 'feel disconnected from people', 'why is everything contracting', 'sad for no reason'], 44], // Al-Qabid/Al-Basit
    [['delayed', 'held back', 'left behind', 'everyone else moving', 'not on my timeline', 'supposed to happen by now', 'not ready yet', 'blocking my progress', 'bitter at someone', 'comparing progress', 'responsibilities holding me back', 'should have happened'], 45], // Al-Muqaddim/Al-Mu'akhkhir
    [['can\'t see the plan', 'life falling apart', 'don\'t understand why', 'feel abandoned', 'pain has no meaning', 'life feels unfair', 'harsh on myself', 'wonder if god notices', 'gentle', 'hardship makes no sense', 'going through divorce', 'lost a job'], 46], // Al-Latif
    [['deserve', 'jealous', 'jealousy', 'transactional', 'ungrateful', 'impossible', 'child', 'going through motions', 'gift', 'bestow', 'envy', 'deeds not enough'], 47], // Al-Wahhab
  ];

  const scores = new Array(nameTeachings.length).fill(0);
  ...
  nameTeachings.forEach((teaching, idx) => {
    for (const ctx of teaching.emotionalContext) {
      const firstWord = ctx.toLowerCase().split(' ')[0];
  ...
  const top = sorted.filter((s) => s.score > 0).slice(0, 3).map((s) => nameTeachings[s.idx]);

  return top.length > 0 ? top : [nameTeachings[0]]; // default to Ar-Rahman
}
