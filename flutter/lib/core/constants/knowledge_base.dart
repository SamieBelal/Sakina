...
const List<NameTeaching> nameTeachings = [
  ...
  NameTeaching(
    ...
    propheticStory:
        "Hudhayfah (رضي الله عنه) prayed a night prayer with the Prophet ﷺ and reported that in his prostration he would say: 'Glory be to my Lord most High.' (Sahih Muslim 772) In our deepest prostration, forehead pressed to the earth, we call upon Al-A'la. The moment you are physically at your lowest is the moment you declare His highest. The one who is humbled before Al-'Azim is honored; the one who is humbled before people loses both worlds.",
    dua: NameTeachingDua(
