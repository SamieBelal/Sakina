...
const List<NameTeaching> nameTeachings = [
  ...
  NameTeaching(
    ...
    propheticStory:
        'The Prophet ﷺ once narrated to his companions about an earlier prophet who, while being beaten and bleeding from his own people, wiped the blood from his face and said: "O Allah! Forgive my people, for they have no knowledge" (Sahih al-Bukhari 3477). The Prophet ﷺ shared this narrative to teach the very disposition of Ar-Rauf — a tenderness that does not retract when it is hurt, a concern that survives violence. At the Battle of Uhud the Prophet ﷺ himself bled and lost a tooth, and at Ta\'if he was stoned until his sandals filled with blood — and the historical narrations record that he too did not curse his attackers but prayed for their guidance. This is Ar-Rauf in human form: a tenderness that does not retract when it is hurt. Allah named this quality in His Prophet twice — raʼuf and rahīm — because it mirrors His own way with us. He sees your worst moments and His first response is not anger. It is concern.',
    dua: NameTeachingDua(
  ...
  NameTeaching(
    ...
    dua: NameTeachingDua(
      ...
      source: 'Jamiʼ at-Tirmidhi 3599 — narrated by Abu Hurayra, a supplication of the Prophet ﷺ (graded Daʻīf by Darussalam — still cited in classical adhkar collections)',
    ),
  ),
