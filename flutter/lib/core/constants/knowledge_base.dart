...
const List<NameTeaching> nameTeachings = [
  ...
  NameTeaching(
    ...
    propheticStory:
        'On the Day of Resurrection, Allah will gather all of creation and then announce: “Where are the kings of the earth? Where are the tyrants? Where are the proud?” Then He will take the heavens and earth in His Grip. Quran 39:67 describes this: “They have not shown Allah His proper reverence — when on the Day of Judgment the whole earth will be in His Grip, and the heavens will be rolled up in His Right Hand. Glorified and Exalted is He above what they associate with Him!” The Prophetic narrations elaborate: Allah will say, “I am the King; where are the kings of the earth?” The contrast is total — every human kingdom dissolves into the single reality of Al-Malik. The lesson for this life: the power someone holds over you is borrowed, temporary, and entirely subject to the One who owns all of it.',
    dua: NameTeachingDua(
      arabic:
  ...
  NameTeaching(
    ...
    propheticStory:
        'When the Prophet ﷺ would wake for night prayer, he began with this supplication — recorded in Sahih al-Bukhari and Sahih Muslim — that centres entirely on Al-Ḥaqq: "O Allah, Lord of the heavens and the earth, and Lord of everything. You are al-Ḥaqq. Your promise is Ḥaqq. Your word is Ḥaqq. The meeting with You is Ḥaqq. Paradise is Ḥaqq. Hell is Ḥaqq. The Prophets are Ḥaqq. Muhammad ﷺ is Ḥaqq. The Hour is Ḥaqq." In a world of fluctuating realities, the Prophet anchored himself before dawn in the Name that is the foundation of all of them. Whatever is Ḥaqq — whatever is real, whatever is certain, whatever will endure — flows from Al-Ḥaqq. This is the theological reality that gives believers courage: your truth, when it is aligned with His Truth, does not depend on whether others acknowledge it.',
    dua: NameTeachingDua(
      arabic: 'رَبَّنَا مَا خَلَقْتَ هَٰذَا بَاطِلًا سُبْحَانَكَ فَقِنَا عَذَابَ النَّارِ',
  ...
  NameTeaching(
    ...
    propheticStory:
        'At the Battle of Uhud, the Prophet ﷺ was wounded, his face bloodied, his tooth broken. He could have cursed those who attacked him. Instead, he said: "O Allah, forgive my people, for they do not know" (Sahih al-Bukhari). The companions were stunned: in the moment of his worst physical pain, the Prophet’s concern was for the well-being of those who had caused it. This is Ar-Rauf in human form: a tenderness that does not retract when it is hurt. Allah named this quality in His Prophet twice — raʼuf and rahīm — because it mirrors His own way with us. He sees your worst moments and His first response is not anger. It is concern.',
    dua: NameTeachingDua(
  ...
  NameTeaching(
    ...
    propheticStory:
        'When the Prophet ﷺ arrived in Madinah after the Hijra, he was a refugee with no property. Within years, he had established a community that cared for hundreds of companions who had left everything in Mecca. He gave until there was nothing left in his house, and then Allah would replenish it. Anas ibn Malik, who served him for ten years, said: "I never saw him refuse a request" (recorded in biographical collections). The man who owned nothing from this world was the most enriched person who ever lived — because Al-Mughni had given him something wealth cannot purchase. What Allah enriched in the Prophet was not his account; it was his ṣadr — his chest. And He can enrich yours.',
    dua: NameTeachingDua(
  ...
  NameTeaching(
    ...
    coreTeaching:
        'An-Nafiʼa is the Bestower of Benefit — the One from whom all good that reaches any created being flows. Where Ad-Darr names divine authorship over hardship, An-Nafiʼa names divine authorship over benefit. Together they form one of the most profound paired Names in Islamic theology: no benefit you receive came from chance, and no harm that reaches you arrived without His knowledge. Every good in your life — every healing, every provision, every meeting that changed your path, every moment of clarity — passed through the hands of An-Nafiʼa before it reached you. The Quran states the principle with precision: "wa-in yuridka bi-khayrin fa-la radda li-fadlihi, yusibu bihi man yashaʼu min ʿibadih" — "if He intends good for you, none can withhold His bounty. He grants it to whoever He wills of His servants" (Quran 10:107). And the pairing with Ad-Darr appears in the 99 Names hadith (Sunan Ibn Majah 3861), confirming prophetic intentionality. But the Name also carries a second truth: Allah created benefit itself. Every genuine good that has ever existed — love, justice, healing, knowledge — originated in An-Nafiʼa. When you act with benefit in mind — when you help, give, heal, speak truth — you are channeling the attribute of the One whose essence is benefit.',
    propheticStory:
        'The Prophet ﷺ said: "The most beloved of people to Allah are those who are most beneficial to people. The most beloved of deeds to Allah is to bring joy to a Muslim, relieve him of distress, pay off his debt, or relieve his hunger" (al-Muʿjam al-Kabir by al-Tabarani — reported with grading discussions in Islamic scholarship). He then added: "Whoever walks with his brother to meet a need is better to him than performing iʿtikaf for two months." The Prophet ﷺ was teaching by example that the human being most aligned with An-Nafiʼa is the one who maximizes benefit to others. You do not merely receive from An-Nafiʼa — you are invited to embody the attribute.',
    dua: NameTeachingDua(
      ...
      translation: 'O Allah, benefit me through what You have taught me, teach me what will benefit me, and increase me in knowledge.',
      source: 'Jamiʼ at-Tirmidhi 3599 — narrated by Abu Hurayra, a supplication of the Prophet ﷺ (Hasan)',
    ),
  ),
