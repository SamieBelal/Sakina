...
const List<NameTeaching> nameTeachings = [
  ...
  NameTeaching(
    ...
    propheticStory:
        'The Prophet ﷺ said: "The most beloved of people to Allah are those who are most beneficial to people. The most beloved of deeds to Allah is to bring joy to a Muslim, relieve him of distress, pay off his debt, or relieve his hunger" (al-Muʿjam al-Kabir by al-Tabarani — reported with grading discussions in Islamic scholarship). He then added: "Whoever walks with his brother to meet a need is better to him than performing iʿtikaf for two months." The Prophet ﷺ was teaching by example that the human being most aligned with An-Nafi is the one who maximizes benefit to others. You do not merely receive from An-Nafi — you are invited to embody the attribute.',
    dua: NameTeachingDua(
