...
alter table public.user_profiles
  ...
  add column if not exists resonant_name_id text,
...
comment on column public.user_profiles.resonant_name_id is 'Onboarding quiz: slug of the Name that resonated (e.g. "ar-rahman"); not a FK — names_of_allah.id is int and Flutter stores slugs.';
