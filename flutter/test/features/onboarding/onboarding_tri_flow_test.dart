...
///   * `reel_first_onboarding_enabled` ON  → the 13-page reel flow (default).
...
void main() {
  ...
  group('flow selection', () {
    testWidgets('reel flag ON renders 13 children', (tester) async {
  ...
  group('activeOnboardingLastPageIndex (three-flow bound)', () {
    test('resolves each flow to its own terminal index', () {
      expect(activeOnboardingLastPageIndex(OnboardingFlowKind.reel), 12);
